...
<p style="margin-top:0.7rem;font-size:0.88rem;color:#555;">
<strong>83% of quad resources flow directly to athlete programs.</strong>
This model operationalizes Harris's framework computationally — Monte Carlo on medal probability,
LP optimization across the full portfolio, efficient frontier showing where marginal medal value
turns negative. A fourth input (preparation gap: dominant program, first Olympics, low readiness)
captures systematic underperformance risk Harris's public framework doesn't address.
</p>
</div>
""", unsafe_allow_html=True)
