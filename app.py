...
<tr><td>Fan Favorite</td><td>US public enthusiasm (0–100%). 100% = Women's Gymnastics All-Around. 80–90% = Basketball, Swimming, Figure Skating. Below 50% = niche community. Displayed for context — not used in LP optimization.</td></tr>
...
<li><strong>Recency-weighted mean</strong> — 45% most recent cycle, 27%, 17%, 11%.</li>
<li><strong>Blended std</strong> — 50% stated + 50% empirical across cycles.</li>
<li><strong>Age-vs-peak</strong> — std +4% per year past peak.</li>
<li><strong>Program depth</strong> — each depth level above 1 compresses std by 6% (floor at depth=5: −24%).</li>
<li><strong>Home Games lift</strong> — +1.5 score points × sport multiplier (Gymnastics 2.2×, T&amp;F Sprint/Hurdles 1.8–2.0×, Swimming 1.3×, Tennis 1.0×).</li>
<li><strong>Pipeline erosion</strong> — std widened up to 25% when feeder programs at risk.</li>
</ol>
P(gold) = share of trials where the US athlete beats the best of N opponents. Protect programs carry an additional preparation gap penalty.</td></tr>
